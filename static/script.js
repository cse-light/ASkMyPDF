...
if (hamburgerBtn && sidebar) {
    hamburgerBtn.addEventListener('click', () => {
        ...
        let expanded = sidebar.classList.contains('active') ? "true" : "false";
...
// === MARKED.JS for Markdown Rendering (from /static/marked.min.js) ===
sendBtn.addEventListener('click', function() {
    sendBtn.classList.add('clicked');
    setTimeout(()=>sendBtn.classList.remove('clicked'), 190);
});
